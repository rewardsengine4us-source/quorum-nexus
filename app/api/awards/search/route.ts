...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // not just "what does it cost". In public mode every visitor has a
    // balance to overlay — either their own real session, or the shared
    // public-demo-user's — so this always runs rather than being gated
    // behind a real sign-in.
